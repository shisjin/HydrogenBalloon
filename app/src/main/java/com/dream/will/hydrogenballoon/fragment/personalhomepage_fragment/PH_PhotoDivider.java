...
public class PH_PhotoDivider extends RecyclerView.ItemDecoration {
    ...
    public PH_PhotoDivider(Context context) {
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final  int buttom =  childAt.getBottom()+layoutParams.bottomMargin;
    ...
    public void getItemOffsets(Rect outRect, int itemPosition, RecyclerView parent) {
        ...
        if (isLastRaw(parent,itemPosition,spanCout,childCount)){
            outRect.set(0,0,mDivider.getIntrinsicWidth(),0);

        }else if (isLastColum(parent,itemPosition,spanCout,childCount)){
